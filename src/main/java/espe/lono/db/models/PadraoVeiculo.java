...
public class PadraoVeiculo {
    ...
    public PadraoVeiculo() {
    }

    public PadraoVeiculo(Integer idPadrao) {
        this.idPadrao = idPadrao;
    }

    public PadraoVeiculo(Integer idPadrao, Date datCad, String sitCad, int usuCad) {
        this.idPadrao = idPadrao;
        this.datCad = datCad;
        this.sitCad = sitCad;
        this.usuCad = usuCad;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PadraoVeiculo)) {
            return false;
        }
        PadraoVeiculo other = (PadraoVeiculo) object;
