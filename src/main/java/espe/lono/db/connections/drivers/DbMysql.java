...
public class DbMysql extends DbConnectionMarcacao
{
    ...
    public DbMysql(int idPub) throws ClassNotFoundException, SQLException
    {
        // Iniciando conexao...
        this.abrirConexao();
    ...
    public DbMysql(int idPub, boolean createTable) throws ClassNotFoundException, SQLException
    {
        // Iniciando conexao...
    ...
    protected void createTable() throws SQLException
    {
        ...
        this.stm.executeUpdate("CREATE TABLE IF NOT EXISTS " + table_name + " ("
                + "id_marcacao BIGINT PRIMARY KEY AUTO_INCREMENT NOT NULL,"
                + "id_tipo_padrao INT NOT NULL,"
                + "num_doc_lucene BIGINT,"
                + "marcacao LONGTEXT,"
                + "marcacao_original LONGTEXT,"
                + "pagina INT,"
                + "linha_pagina INT,"
        ...
        // Criando indexes
        this.stm.executeUpdate("CREATE INDEX idx0 ON " + table_name + "(id_tipo_padrao)");
        this.stm.executeUpdate("CREATE INDEX idx1 ON " + table_name + "(num_doc_lucene)");
    }
    ...
    protected void abrirConexao() throws SQLException {
        for ( int contador = 0; contador <= 3; contador++ )
        {
            try
            {
                ...
                {
                    this.conn = DbMysql.GetConnectionFromPooling();
    ...
    public boolean exportTable(String outputCSVFName, boolean deleteAfterExport) {
        ...
        try {
            ...
            if ( deleteAfterExport )
                this.destruirTabela(this.idPublicacao);
